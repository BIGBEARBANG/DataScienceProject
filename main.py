...
with st.echo(code_location='below'):
    ...
    st.plotly_chart(fig)
    ### END FROM
    st.caption("Данные визуализованы в виде boxplot графиков, построенных в соответсвии с годовыми наблюдениями и расстортированных по типу данных") 

    st.caption("Корреляция между основыми показателями музейной деятельности")
    #Heatmap
    df_m_corr=df_m.corr()
    ...
    st.caption("Данные сгруппированы по одному из 4 типов музейных институций")
